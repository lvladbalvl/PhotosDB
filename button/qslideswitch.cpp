...
void QSlideSwitchPrivate::drawSlider(QPainter *painter)
{
    ...
    gradient.setColorAt(0, QColor(0,130,130));
    gradient.setColorAt(1, QColor(0,130,130));
    ...
    gradient.setColorAt(0, QColor(0,140,140));
    gradient.setColorAt(1, QColor(0,160,160));
	...
	// draw slider
    gradient.setColorAt(0, QColor(0,180,0));
    gradient.setColorAt(1, QColor(0,240,0));
	...
	painter->setPen(QPen(QBrush(gradient), 0));
        ...
        painter->drawText(0, 0, r.width()/2, r.height()-1, Qt::AlignCenter, tr("File System Orientation"));

        painter->drawText(r.width()/2, 0, r.width()/2, r.height()-1, Qt::AlignCenter, tr("Tag Orientation"));
